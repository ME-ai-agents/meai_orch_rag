...
from .semantic_profile_manager import SemanticProfileManager
from .neo4j_itsm_manager import ITSMOntologyManager
from .rag_knowledge_base import RAGKnowledgeBase
from .enhanced_prompt_templates import SemanticProfilePromptManager
...
class MEAIEnhancedOrchestrator:
    ...
    def __init__(self, config=None):
        ...
        self.config = config or {
            ...
            "opensearch_index": os.environ.get('OPENSEARCH_INDEX', 'meai-knowledge'),
